...
public class BorderConfig {
	...
	private void initActions() {
		...
		// shrinked un/checked
		shrinkCheckBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				shrinkSlider.setEnabled(shrinkCheckBox.isSelected());
			}
		});

		// slideshow un/checked
		slideshowCheckBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				slideShowPause.setEnabled(slideshowCheckBox.isSelected());
			}
		});

		// insert files
		insertFilesButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
